...
async function authRoutes(app) {
    app.post("/register", async (request) => {
        ...
        const accessTokenResponde = await axios_1.default.post("https://github.com/login/oauth/access_token", null, {
            params: {
        ...
        // Não colocar informações sensíveis porque qualquer um pode ler
